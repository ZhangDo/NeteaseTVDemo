...
class WKRecentPodcastListVC: UIViewController {
    @IBOutlet weak var collectionView: UICollectionView!
    fileprivate var podcastModels = [NRDJRadioModel]()
    static func creat() -> WKRecentPodcastListVC {
        let vc = UIStoryboard(name: "Main", bundle: .main).instantiateViewController(identifier: String(describing: self)) as! WKRecentPodcastListVC
        return vc
    }
...
extension WKRecentPodcastListVC: UICollectionViewDelegate, UICollectionViewDataSource {
...
extension WKRecentPodcastListVC {
